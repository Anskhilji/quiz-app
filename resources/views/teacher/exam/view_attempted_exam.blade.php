...
//                            dd($paper->)
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control subjective_total" value="{{$sub_total}}" readonly>
                                    </div>
                                </div>
                                <div class="form-group col-6 mr-4 ml-4" style="box-sizing: border-box">
                                    ...
                                    //                                dd($result);
                                    ?>
                                    <textarea name="t{{$text->id}}-ans" rows="5" cols="5" disabled class="form-control" placeholder="">{{ (!empty($result)) ? $result['ans'] : ""}}</textarea>
                                </div>
            ...
            <div class="row">
                <div class="box">
                    @php($i =1)
                    <form action="{{ route('store.marks', $id) }}" method="post" >
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="sbj_total" readonly class="form-control sub_t" placeholder="Subjective total marks" value="{{$_total}}">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="sbj_obtained" readonly class="form-control obtained_get_total" placeholder="Subjective obtained marks">
                                <span class="text-danger">@error('sbj_obtained'){{ $message }}@enderror</span>
                            </div>
                        </div>

                       <div class="form-group">
                           <input type="submit" value="Submit" class="btn btn-primary ml-4">
                       </div>
                    </form>
                </div>
            </div>
