                        ...
                        <form action="{{ route('student.login') }}" method="post">
                            ...
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="id" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Student ID">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="fog-pwd text-right">
                                        <a href="{{ route('student.reset.password') }}" class="text-white hover-info"><i class="ion ion-locked"></i> Forgot pwd?</a><br>
                                    </div>
                                </div>
                                <!-- /.col -->
