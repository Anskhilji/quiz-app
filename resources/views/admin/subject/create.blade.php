                ...
                <div class="row">
                    <div class="col-12">
                        <div class="box">
                            ...
                            <form class="form-horizontal form-element" action="{{ route('store.subject') }}" method="post">
                                @csrf
                                <div class="box-body">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Subject Name</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="subject_name" class="form-control" id="inputEmail3" placeholder="Enter subject">
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-rounded btn-info pull-right">Add Subject</button>
                                </div>
                                <!-- /.box-footer -->
                            </form>
                        </div>
